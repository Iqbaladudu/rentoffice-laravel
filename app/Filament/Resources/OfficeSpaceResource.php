        ...
        public static function form(Form $form): Form
        {
            return $form
                ->schema([
                    ...
                    Forms\Components\Repeater::make("benefits")->relationship("benefits")->schema([
                    ...
                    Forms\Components\Select::make("is_full_booked")->options([
                        true => "Available",
                        false => "Not Available"
                    ])->required()
                ]);
        ...
        public static function table(Table $table): Table
        {
            return $table
                ->columns([
                    ...
                    Tables\Columns\IconColumn::make("is_full_booked")->boolean()->trueColor("danger")->falseColor("success")->trueIcon("heroicon-o-check-circle")->falseIcon("heroicon-o-x-check-circle")
                        ->label("Available")
                ])
                ->filters([
                    Tables\Filters\SelectFilter::make("city_id")->label("City")->relationship("city", "name")
                ])
                ->actions([
