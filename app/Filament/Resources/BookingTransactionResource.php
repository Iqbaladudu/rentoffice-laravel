        ...
        public static function form(Form $form): Form
        {
            return $form
                ->schema([
                    ...
                    Forms\Components\Select::make("office_space_id")->relationship("officeSpace", "name")->searchable()->preload()->required(),
                ]);
        }
        ...
        public static function table(Table $table): Table
        {
            return $table
                ->columns([
                    ...
                    Tables\Columns\TextColumn::make("officeSpace.name")->searchable(),
                    Tables\Columns\TextColumn::make("started_at")->date(),
                    Tables\Columns\IconColumn::make("is_paid")->boolean()->trueColor("danger")->falseColor("success")->trueIcon("heroicon-o-check-circle")->falseIcon("heroicon-o-x-check-circle")->label("Sudah Bayar?")
                ])
                ->filters([
                    //
                ])
